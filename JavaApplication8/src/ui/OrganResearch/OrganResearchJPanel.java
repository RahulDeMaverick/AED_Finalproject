 ...
 * @author kashr
 */
public class OrganResearchJPanel extends javax.swing.JPanel {
        EcoSystem system;
    String DonorAdminID;
    JPanel container;
     ...
     */
    public OrganResearchJPanel(JPanel _container, EcoSystem _business, String _DonorID) {
        initComponents();
       ...
       jLabel2.setText("Welcome "+ donordir.getOrganResearcherName(DonorAdminID)+ " to "+jLabel2.getText());
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/organbank.jpg"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Forte", 1, 36)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Organ Research Center");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Age", "Blood Group", "Phone Number", "insurance Number", "Email Address", "Address", "City", "Organs to Donate"
            }
        ) {
...
//    statement.setString(2,password);
    ...
    {  hospitals.add(rs.getString("hospitalName"));
                ...
                Logger.getLogger(OrganResearchJPanel.class.getName()).log(Level.SEVERE, null, ex);
            }
    finally
...
{ jdbcConnection jdbconnection = new jdbcConnection();
 Connection conn = jdbconnection.connect();
        try {
            ...
            String sql = "SELECT * FROM donorTable WHERE organDonation=1";
            PreparedStatement statement = conn.prepareStatement(sql);
            ...
            //{
              ...
              row[8] = rs.getString("organsToDonate");
              model.addRow(row);
           // }
            }
